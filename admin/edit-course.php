...
<div class="form-group">
    <label for="courseunit">Course Faculty  </label>
    <input type="text" class="form-control" id="courseunit" name="courseunit" placeholder="Course Faculty" value="<?php echo htmlentities($row['courseUnit']);?>" required />
  </div>
